...
public class PanDingBean implements Serializable {

    /**
     * parts : {"createDate":"2018-03-22 19:33:01","updateDate":"2018-03-22 19:33:01","createBy":null,"updateBy":null,"partsId":"aaa","partsRoNo":"121212","partsLineNo":2,"partsIsMainpart":"1","partsAmount":12111,"partsAscCode":"wwwwwwwwww","partsAscName":"哈哈","partsVin":"bbb              ","partsEngineNo":"呵呵","partsModel":null,"partsSeries":null,"partsMileage":null,"partsClaimType":"免费检测","partsTroubleDesc":"房交会的数据恢复好的师傅好看的舒服的舒服的舒服康师傅的空间和扩大收费","partsTroubleReason":"飞洒发生的范德萨发的是范德萨范德萨发都是飞洒地方的","partsClaimSubmitDate":"2018/03/30","partsTranswrCreateDate":null,"partsBackAddress":"召唤师峡谷","partsBackWays":null,"partsReturnPartCode":"sdasdasdasdasdsada","partsReturnPartName":"都是飞洒发挥空间都是反馈及时答复和空间都是风景和辅导书","partsQuantity":1,"partsBatch":"201803","partsNoBackDes":null,"partsProcessState":6,"partsSecondJudgeReason":"回运件为非本批次回运零件","partsOtherJudgeReason":"回运件为非本批次回运零件","partsReturnResult":"发广播大学","partsQrUrl":null,"encasementCode":null,"partsEncasementId":"1","partsOutstorageId":"3","partsPutstorageId":"4eac7112040341a78eb906ed39eda4e5","partsTwrPartId":null,"operateFlag":null,"partsRemark":null,"partsStorage":null,"partsOutNumber":null}
     * processState : [{"value":"11","label":"无需回运"},{"value":"7","label":"待重新入库"},{"value":"12","label":"下月回运"},{"value":"14","label":"报废"}]
     */

    private PartsBean parts;
    private List<ProcessStateBean> processState;
    ...
    public List<ProcessStateBean> getProcessState() {
        return processState;
    }

    public void setProcessState(List<ProcessStateBean> processState) {
        this.processState = processState;
    }

    public static class PartsBean implements Serializable{
        /**
         * createDate : 2018-03-22 19:33:01
         * updateDate : 2018-03-22 19:33:01
         * createBy : null
         * updateBy : null
         * partsId : aaa
         * partsRoNo : 121212
         ...
         * partsMileage : null
         * partsClaimType : 免费检测
         * partsTroubleDesc : 房交会的数据恢复好的师傅好看的舒服的舒服的舒服康师傅的空间和扩大收费
         * partsTroubleReason : 飞洒发生的范德萨发的是范德萨范德萨发都是飞洒地方的
         * partsClaimSubmitDate : 2018/03/30
         * partsTranswrCreateDate : null
         * partsBackAddress : 召唤师峡谷
         * partsBackWays : null
         * partsReturnPartCode : sdasdasdasdasdsada
         * partsReturnPartName : 都是飞洒发挥空间都是反馈及时答复和空间都是风景和辅导书
         * partsQuantity : 1
         * partsBatch : 201803
         * partsNoBackDes : null
         * partsProcessState : 6
         * partsSecondJudgeReason : 回运件为非本批次回运零件
         * partsOtherJudgeReason : 回运件为非本批次回运零件
         * partsReturnResult : 发广播大学
         * partsQrUrl : null
         * encasementCode : null
         * partsEncasementId : 1
         * partsOutstorageId : 3
         * partsPutstorageId : 4eac7112040341a78eb906ed39eda4e5
         * partsTwrPartId : null
         * operateFlag : null
         * partsRemark : null
         * partsStorage : null
        ...
        private String partsBackAddress;
        ...
        public String getPartsBackAddress() {
            return partsBackAddress;
        }

        public void setPartsBackAddress(String partsBackAddress) {
            this.partsBackAddress = partsBackAddress;
        }
        ...
        public String getPartsNoBackDes() {
            return partsNoBackDes;
        }

        public void setPartsNoBackDes(String partsNoBackDes) {
            this.partsNoBackDes = partsNoBackDes;
        }
